...
: ${AMENT_CURRENT_PREFIX:="/root/common/indy-ros2/install/indy_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/indy_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/indy_gazebo/environment/path.sh"
