...
: ${AMENT_CURRENT_PREFIX:="/root/common/indy-ros2/install/indy_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/indy_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/indy_description/environment/path.sh"
